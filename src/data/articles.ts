...
export const ARTICLES: Article[] = [
  {
    ...
    blocks: [
      ...
      { t: 'ul', c: ['Roof, gutters, and drainage before each wet season', 'Appliance filters cleaned or replaced on schedule', 'Fixtures, water shutoffs, and visible leaks', 'Smoke and carbon monoxide detectors', 'Exterior caulking, paint, and weather sealing', 'Common areas: lighting, handrails, and trip hazards', 'Landscaping and grading directed away from the foundation'] },
      { t: 'h2', c: 'What to hand off' },
      { t: 'p', c: 'The items that need the right contractor, a paper trail, or a fast turnaround are the ones worth coordinating through a single operator. You send the work order; the assessment, the contractor, the documentation, and the closeout come back as one record.' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'ul', c: ['Securing and board-up of entries', 'Lock changes and access control', 'Debris removal and cleanouts', 'Interior cleaning', 'Lawn and grounds maintenance', 'Winterisation of water lines and systems', 'Repairs that protect condition', 'Inspections and condition reporting'] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'ul', c: ['Appliance checks before peak season', 'Water heaters, shutoffs, and visible leaks', 'Roof and gutter checks before wet weather', 'Seals, caulking, and weatherproofing', 'Smoke and carbon monoxide detectors and alarms'] },
